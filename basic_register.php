...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $membership_id = 'FZ-BASIC-' . date('Y') . '-' . strtoupper(substr(uniqid(), 7));
        $join_date = date('Y-m-d');
        $renewal_date = date('Y-m-d', strtotime('+1 month'));
        
        $stmt = $conn->prepare("INSERT INTO members (fullname, email, phone, password, membership_id, membership_plan, join_date, renewal_date) VALUES (?, ?, ?, ?, ?, 'basic', ?, ?)");
...
<head>
    ...
    <title>Basic Plan Registration - FitZone</title>
    ...
    <div class="registration-container">
        ...
        <div class="plan-highlight">
            ...
            <ul>
                ...
                <li>Standard Equipment Access</li>
        ...
        <?php if ($success): ?>
            <div class="success-message">
                ...
                <p>Welcome to FitZone! Your membership will be activated within 24 hours.</p>
            </div>
        <?php else: ?>
