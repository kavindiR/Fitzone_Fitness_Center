...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        $membership_id = 'FZ-PREMIUM-' . date('Y') . '-' . strtoupper(substr(uniqid(), 7));
        $join_date = date('Y-m-d');
        $renewal_date = date('Y-m-d', strtotime('+1 month'));
        
        $stmt = $conn->prepare("INSERT INTO members (fullname, email, phone, password, membership_id, membership_plan, join_date, renewal_date) VALUES (?, ?, ?, ?, ?, 'premium', ?, ?)");
...
<head>
    ...
    <title>Premium Plan Registration - FitZone</title>
...
<body>
    ...
    <div class="registration-container">
        <h1>Premium Plan Registration</h1>
        ...
        <?php else: ?>
            <form method="post" action="">
                ...
                <div class="submit-btn">
                    <button type="submit">Start Your Premium Journey</button>
                </div>
            </form>
        <?php endif; ?>
    </div>
